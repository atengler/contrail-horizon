...
from contrail_openstack_dashboard.openstack_dashboard.dashboards.project.networking import workflows \
...
class CreateSubnet(network_workflows.CreateNetwork):
    ...
    def get_success_url(self):
        return reverse("horizon:project:networking:detail",
...
class UpdateSubnet(network_workflows.CreateNetwork):
    ...
    failure_url = "horizon:project:networking:detail"
