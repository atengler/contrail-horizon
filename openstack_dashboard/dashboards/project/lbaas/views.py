...
from contrail_openstack_dashboard.openstack_dashboard.dashboards.project.lbaas \
...
class IndexView(tabs.TabView):
    ...
    template_name = 'project/lbaas/details_tabs.html'
...
class UpdatePoolView(forms.ModalFormView):
    ...
    template_name = "project/lbaas/updatepool.html"
    context_object_name = 'pool'
    success_url = reverse_lazy("horizon:project:lbaas:index")
...
class UpdateVipView(forms.ModalFormView):
    ...
    template_name = "project/lbaas/updatevip.html"
...
class UpdateMemberView(forms.ModalFormView):
    ...
    template_name = "project/lbaas/updatemember.html"
...
class UpdateMonitorView(forms.ModalFormView):
    ...
    template_name = "project/lbaas/updatemonitor.html"
