...
from contrail_openstack_dashboard.openstack_dashboard.dashboards.project.lbaas import views


urlpatterns = patterns(
    'contrail_openstack_dashboard.openstack_dashboard.dashboards.project.lbaas.views',
