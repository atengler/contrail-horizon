...
from contrail_openstack_dashboard.openstack_dashboard.dashboards.project.lbaas import workflows
...
class LoadBalancerTests(test.TestCase):
    ...
    DASHBOARD = 'project'
    INDEX_URL = reverse_lazy('horizon:%s:lbaas:index' % DASHBOARD)

    ADDPOOL_PATH = 'horizon:%s:lbaas:addpool' % DASHBOARD
    ADDVIP_PATH = 'horizon:%s:lbaas:addvip' % DASHBOARD
    ADDMEMBER_PATH = 'horizon:%s:lbaas:addmember' % DASHBOARD
    ADDMONITOR_PATH = 'horizon:%s:lbaas:addmonitor' % DASHBOARD

    POOL_DETAIL_PATH = 'horizon:%s:lbaas:pooldetails' % DASHBOARD
    VIP_DETAIL_PATH = 'horizon:%s:lbaas:vipdetails' % DASHBOARD
    MEMBER_DETAIL_PATH = 'horizon:%s:lbaas:memberdetails' % DASHBOARD
    MONITOR_DETAIL_PATH = 'horizon:%s:lbaas:monitordetails' % DASHBOARD

    UPDATEPOOL_PATH = 'horizon:%s:lbaas:updatepool' % DASHBOARD
    UPDATEVIP_PATH = 'horizon:%s:lbaas:updatevip' % DASHBOARD
    UPDATEMEMBER_PATH = 'horizon:%s:lbaas:updatemember' % DASHBOARD
    UPDATEMONITOR_PATH = 'horizon:%s:lbaas:updatemonitor' % DASHBOARD

    ADDASSOC_PATH = 'horizon:%s:lbaas:addassociation' % DASHBOARD
    DELETEASSOC_PATH = 'horizon:%s:lbaas:deleteassociation' % DASHBOARD
    ...
    def test_update_pool_get(self):
        ...
        self.assertTemplateUsed(res, 'project/lbaas/updatepool.html')
    ...
    def test_update_vip_get(self):
        ...
        self.assertTemplateUsed(res, 'project/lbaas/updatevip.html')
    ...
    def test_update_member_get(self):
        ...
        self.assertTemplateUsed(res, 'project/lbaas/updatemember.html')
    ...
    def test_update_monitor_get(self):
        ...
        self.assertTemplateUsed(
            res, 'project/lbaas/updatemonitor.html')
