...
class AddInterfaceView(forms.ModalFormView):
    ...
    template_name = 'project/l3routers/ports/create.html'
    success_url = 'horizon:project:l3routers:detail'
...
class SetGatewayView(forms.ModalFormView):
    ...
    template_name = 'project/l3routers/ports/setgateway.html'
    success_url = 'horizon:project:l3routers:index'
